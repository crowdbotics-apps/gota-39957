"""
Django settings for gota_39957 project.
...
WSGI_APPLICATION = 'gota_39957.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gota_39957 API",
    "DESCRIPTION": "API documentation for gota_39957 App",
    "VERSION": "v1",
}
